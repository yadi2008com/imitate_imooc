...
public class MyCourseActivity extends  Activity   {
    ...
    private final String CITY_PATH_JSON="http://119.29.85.27/Imooc/MyCourseServlet?type=json&userid=2";
    private final String CITY_PATH_JSON2="http://119.29.85.27/Imooc/MyCourseYxServlet?type=json&userid=2";
	...
	public class MyAsyncTask extends AsyncTask<String,Void,List<Map<String, Object>>>{
		...
		protected void onPostExecute(List<Map<String, Object>> result){
			...
			simpleAdapter = new SimpleAdapter(MyCourseActivity.this,
