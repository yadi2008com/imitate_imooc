...
<script src="Home/Js/course.js" async="" charset="utf-8"></script>
	...
	<div id="main">
				...
				<div class="course-tool-bar clearfix">
					<div class="tool-left l">
						<a href="<%=request.getContextPath()%>/MyCourseServlet"
							class="sort-item ">已关注 </a> <a
							href="<%=request.getContextPath()%>/MyCourseYxServlet"
							class="sort-item active">已学</a>
					</div>
					
						<%
					List<CourseBean> courseBeanList=(List<CourseBean>)request.getAttribute("courseBeanList");
       ...
       %>
					...
					<div class="tool-right r">
						...
						</span> <a href="<%=request.getContextPath()%>/MyCourseServlet?pageno=<%=pageBean.getPageno() - 1%> ">上一页</a> 
						<a href="<%=request.getContextPath()%>/MyCourseServlet?pageno=<%=pageBean.getPageno() + 1%>">下一页</a>
						</span> 
					</div>
				</div>
				...
				<ul class="follow-list">
					<li data-id="509"><a class="btn-del js-btn-del"></a>
						...
						<div class="box-right">
							...
							<div class="study-btm">
								<a href="<%=courseBean.getCour_url()%>" class="beginstudy"
