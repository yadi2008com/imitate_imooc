...
-->
					...
					<div class="setting-bindsns">
						...
						<div class="setting-bindsns-inner clearfix">
							<div class="setting-bindsns-weixin l">
								...
								<p>未绑定帐号</p>
								<a href="/user/loginweixin?action=bindweixin" aria-role="button"
									hidefocus="true" class="rlf-btn-green sbtn-green js-bind ">立即绑定</a>
							</div>
							<div class="setting-bindsns-weibo l">
								<i class="icon-weibo"></i>
								<p>未绑定帐号</p>
								<a href="/user/loginweibo?action=bindweibo" aria-role="button"
									hidefocus="true" class="rlf-btn-green sbtn-green js-bind ">立即绑定</a>
							</div>
							...
							<div class="setting-bindsns-qq l">
								<i class="icon-qq"></i>
								<p>未绑定帐号</p>
								<a href="/user/loginqq?action=bindqq" aria-role="button"
									hidefocus="true" class="rlf-btn-green sbtn-green js-bind">立即绑定</a>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript">
		var UserEmail = "283454539@qq.com"
	</script>
