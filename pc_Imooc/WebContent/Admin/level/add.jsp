...
<form action="<%=request.getContextPath()%>/LevelAddServlet"
	method="post">
	<table class="table table-bordered table-hover definewidth m10">

		<tr>
			<td width="10%" class="tableleft">等级</td>
			<td><input type="text" name="leve_name" />&nbsp;<h7
					style="color:#FF0000;<%if ((request.getAttribute("message1") == null)
					&& (request.getAttribute("message2") == null)) {%>visibility: hidden<%}%>">等级为空或重名！</h7></td>
		</tr>
