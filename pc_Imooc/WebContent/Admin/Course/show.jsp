...
<body>
	...
	<table style="width: 300px;float: left; margin-left: 30px" class="table table-bordered table-hover definewidth m10">
		<thead>
			<tr>
				<th width="20%">课程id</th>
				<td><%=courseBean.getCourse_id()%></td></tr><tr>
				<th>课程标题</th>
				<td><%=courseBean.getCour_title()%></td></tr><tr>

				<th>缩略图</th>
				<td><%=courseBean.getCour_image()%></td></tr><tr>

				<th>地址</th>
				<td><%=courseBean.getCour_url()%></td></tr><tr>

				<th>时长</th>
				<td><%=courseBean.getCour_duration()%></td></tr><tr>

				<th>点击量</th>
				<td><%=courseBean.getCour_hot()%></td></tr><tr>

				<th>发布时间</th>
				<td><%=courseBean.getCour_date()%></td></tr><tr>

				<th>资源</th>
				<td><%=courseBean.getCour_source()%></td></tr><tr>

				<th>简介</th>
				<td><%=courseBean.getCour_content()%></td></tr><tr>

				<th>语言</th>
				<td><%=courseBean.getCour_language()%></td></tr><tr>

				<th>教师</th>
				<td><%=courseBean.getCour_teacher()%></td></tr><tr>

				<th>类型id</th>
				<td><%=courseBean.getLanguage_id()%></td></tr><tr>

				<th>方向id</th>
				<td><%=courseBean.getDecoration_id()%></td></tr><tr>

				<th>难度id</th>
				<td><%=courseBean.getLevel_name()%></td></tr><tr>
