	...
	protected void doGet(HttpServletRequest request,
		...
		if (userid2 != 0) {
			...
			if ("json".equals(type)) {
				...
				courseBeanList = myCourseBiz.fetchMyCourseWhereFocusInfo(
						userid2, 1);
			...
			int rows = myCourseBiz.fetchMyCourseWhereFocusInfoRows(user_id);
			...
			courseBeanList = myCourseBiz.fetchMyCourseWhereFocusInfo(user_id,
					pageno);
			...
			request.getRequestDispatcher("/Home/user_mycourse_ygz.jsp")
